  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0b0d12] px-6 py-20 text-white">
      ...
      <section className="relative w-full max-w-md rounded-2xl border border-white/12 bg-black/35 p-8 shadow-[0_20px_80px_rgba(0,0,0,0.45)] backdrop-blur-xl">
        ...
        <p className="mt-2 text-sm text-white/60">Choose a username and password to create your account.</p>
        ...
        >
          ...
          />
          <label className="mb-2 mt-4 block text-xs uppercase tracking-[0.12em] text-white/65" htmlFor="confirmPassword">
            Confirm password
          </label>
          <input
            id="confirmPassword"
          ...
          <button
            type="submit"
            className="mt-6 inline-flex w-full items-center justify-center border border-white/20 bg-white/10 px-4 py-2.5 text-sm font-medium text-white transition hover:border-white/35 hover:bg-white/15"
          >
            Create account
          </button>
        </form>
        <p className="mt-5 text-center text-sm text-white/70">
          ...
          <a href="/sign-in" className="text-white underline decoration-white/40 underline-offset-4 hover:decoration-white">
            Sign in
          </a>
          .
        </p>
